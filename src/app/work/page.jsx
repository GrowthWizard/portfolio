...
import logoDrYun from '@/images/logos/logo-dr-yun.png'
...
const projects = [
  ...
  },
  {
    name: 'wptonext.com',
    description:
      'Kostenloses Tool, dass es dir ermöglicht deine Yoast SEO oder RankMath Weiterleitungen zu next.js zu konvertieren.',
    link: { href: 'https://wptonext.com', label: 'wptonext.com' },
    logo: logoWpToNext,
    alt: "Logo wptonext.com",
  },
  {
    name: 'LeoRes',
    description:
...
export const metadata = {
  title: 'Portfolio: Die Früchte meiner Arbeit | steindominik.de',
  description: '8 Jahre Erfahrung in der Suchmaschinenoptimierung haben meine Herangehensweise an die Entwicklung von Webseiten geprägt.',
}
      ...
      >
        {projects.map((project) => (
          <Card as="li" key={project.name}>
            ...
            <p className="relative z-10 mt-6 flex text-sm font-medium text-light-purple transition group-hover:text-rosa dark:text-zinc-200 dark:hover:text-rosa">
